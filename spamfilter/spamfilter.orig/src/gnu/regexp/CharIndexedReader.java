...
class CharIndexedReader implements CharIndexed {
  ...
  CharIndexedReader(Reader str, int index) {
    if (str instanceof BufferedReader) br = (BufferedReader) str;
    else br = new BufferedReader(str,BUFFER_INCREMENT);
